    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateUser',$user->user_id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <select class="custom-select @error('role') is-invalid @enderror" name="role" required value="{{$user->role}}">
